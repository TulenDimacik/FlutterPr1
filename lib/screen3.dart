      ...
      body: SafeArea(
        child: Column(children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Image.asset("lib/assets/img4.png"),
              ),
            ],
          ),
          Row(
          ...
          Container(
            ...
            child: Image.asset("lib/assets/img5.png"),
          ),
          Container(
            margin: const EdgeInsets.fromLTRB(20, 5, 0, 0),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Image.asset("lib/assets/img6.png"),
              ),
              Container(
                height: 95,
                width: 140,
                margin: const EdgeInsets.fromLTRB(0, 0, 20, 0),
                child: Image.asset("lib/assets/img7.png"),
              ),
            ],
          ),
          Row(
          ...
          Row(
            ...
            children: [
              Container(
                ...
                width: 140,
                margin: const EdgeInsets.fromLTRB(20, 0, 0, 0),
                child: Image.asset("lib/assets/img8.png"),
              ),
              Container(
                height: 95,
                width: 140,
                margin: const EdgeInsets.fromLTRB(0, 0, 20, 0),
                child: Image.asset("lib/assets/img9.png"),
              ),
            ],
          ),
          Row(
