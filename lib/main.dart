...
void main() async {
  ...
  //       email: "email@mail.ru", password: "KrutoyParol1337");
  // } on FirebaseAuthException catch (e) {
  //   if (e.code == 'weak-password') {
  //     print('Пароль слишком слабый.');
  //   } else if (e.code == 'email-already-in-use') {
  //     print('Этот адрес электронной почты уже используется');
  //   }
  // } catch (e) {
  //   print(e);
  // }
  ...
  //         email: "isip_d.a.gordyushin@mpt.ru", password: "dima2003123")
  //     .then((value) {
...
// Sign the user in (or link) with the credential
                ...
                ElevatedButton(
                  onPressed: () async{
                    await Navigator.pushNamed(context, Registration.routeName);
                  },
